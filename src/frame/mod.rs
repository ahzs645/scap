...
pub enum Frame {
    ...
    /// Microphone audio frame data
    MicrophoneAudio(AudioFrame),
}
...
/// Audio frame containing PCM audio data
#[derive(Debug, Clone)]
pub struct AudioFrame {
    /// Timestamp of the audio frame in nanoseconds
    pub display_time: u64,
    ...
    /// Audio data in interleaved PCM format (typically f32 or i16)
    pub data: Vec<u8>,
    /// Bits per sample (e.g., 16, 24, 32)
    pub bits_per_sample: u32,
    /// Whether the audio is from system or microphone
